...
api: "POST /organizations/{organizationId}/memberships/{membershipId}/deactivate"
description: "Deactivate a membership."
---

Deactivates a membership by its ID.

<Info>Requires `memberships:deactivate` permission.</Info>
